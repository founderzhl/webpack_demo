...
module.exports = {
    entry: { //配置入口文件，有几个写几个
        ...
        list: './dev/js/page/list.js',
        about: './dev/js/page/about.js',
    },
    output: { 
        path: path.join(__dirname, 'pub'), //输出目录的配置，模板、样式、脚本、图片等资源的路径配置都相对于它
        publicPath: '/pub/',                //模板、样式、脚本、图片等资源对应的server上的路径
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
            ...
            template: './dev/html/index.html', //html模板路径
        ...
        new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
            ...
            template: './dev/html/list.html', //html模板路径
        ...
        new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
            ...
            template: './dev/html/about.html', //html模板路径
            inject: true, //js插入的位置，true/'head'/'body'/false
            hash: true, //为静态资源生成hash值
